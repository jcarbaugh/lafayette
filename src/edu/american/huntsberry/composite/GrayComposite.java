...
public class GrayComposite extends BaseComposite {
    
    private Dimension d;
    private UserInterface ui;
	
	public GrayComposite(UserInterface ui, Dimension d) {
		super(ui);
		this.d = d;
		this.ui = ui;
	}
	...
	public void init(Graphics2D g2, CompositeController cc) { 
		...
		ce.setShape(p);
		ce.setBackgroundColor(Color.GRAY);
		ce.setOutlineColor(Color.GRAY);
